...
public class phptravelsForm {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		driver.findElement(By.xpath("//input[@class='first_name form-control']")).sendKeys("Inba");     //send values to firstname
		
		
		driver.findElement(By.xpath("//input[@class='last_name form-control']")).sendKeys("Venu");   //send values to laste name
	
		
		driver.findElement(By.xpath("//input[@class='business_name form-control']")).sendKeys("Civil");    //send values to bussines name
		
		
		driver.findElement(By.xpath("//input[@class='email form-control']")).sendKeys("inbavenu04@gmail.com");    //send the values to email
	...
	File destination =new File("C:\\Users\\USER\\eclipse-workspace\\TestExcel\\src\\main\\java\\Task22\\phptravels.png");    //give file destination
